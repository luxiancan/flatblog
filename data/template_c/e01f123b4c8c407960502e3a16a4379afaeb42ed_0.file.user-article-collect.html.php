<?php
/* Smarty version 3.1.31, created on 2017-06-17 18:24:11
  from "F:\XAMPP\htdocs\flatBlog\tpl\index\user-article-collect.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5945034b62d5c6_81232010',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e01f123b4c8c407960502e3a16a4379afaeb42ed' => 
    array (
      0 => 'F:\\XAMPP\\htdocs\\flatBlog\\tpl\\index\\user-article-collect.html',
      1 => 1497431368,
      2 => 'file',
    ),
  ),
...
function content_5945034b62d5c6_81232010 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
&menu=articles&type=comment"><?php if ($_smarty_tpl->tpl_vars['indexauth']->value != '' && $_smarty_tpl->tpl_vars['indexauth']->value['username'] == $_smarty_tpl->tpl_vars['user_info']->value['username']) {?>我<?php } else { ?>Ta<?php }?>的评论</a>
                        ...
                        <div class="main-content">
                            <div class="con-wrap">
                                <?php if (count($_smarty_tpl->tpl_vars['collect_data']->value) != 0) {?>
                                <div class="article-list">
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['collect_data']->value, 'value', false, NULL, 'name', array (
));
if ($_from !== null) {
