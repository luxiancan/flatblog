<?php
/* Smarty version 3.1.31, created on 2017-06-14 17:50:29
  from "F:\XAMPP\htdocs\flatBlog\tpl\index\user-article-praise.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_594106e5741b26_12584455',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '93668ff4feb6ce1342cc0e71cc9177a4590f3e8a' => 
    array (
      0 => 'F:\\XAMPP\\htdocs\\flatBlog\\tpl\\index\\user-article-praise.html',
      1 => 1497431376,
      2 => 'file',
    ),
  ),
...
function content_594106e5741b26_12584455 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
&menu=articles&type=comment"><?php if ($_smarty_tpl->tpl_vars['indexauth']->value != '' && $_smarty_tpl->tpl_vars['indexauth']->value['username'] == $_smarty_tpl->tpl_vars['user_info']->value['username']) {?>我<?php } else { ?>Ta<?php }?>的评论</a>
                        ...
                        <div class="main-content">
                            <div class="con-wrap">
                                <?php if (count($_smarty_tpl->tpl_vars['praise_data']->value) != 0) {?>
                                <div class="article-list">
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['praise_data']->value, 'value', false, NULL, 'name', array (
));
if ($_from !== null) {
