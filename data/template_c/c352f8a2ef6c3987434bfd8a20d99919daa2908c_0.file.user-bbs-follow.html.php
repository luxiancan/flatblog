<?php
/* Smarty version 3.1.31, created on 2017-06-14 17:50:36
  from "F:\XAMPP\htdocs\flatBlog\tpl\index\user-bbs-follow.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_594106ecb4fbe4_47130917',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c352f8a2ef6c3987434bfd8a20d99919daa2908c' => 
    array (
      0 => 'F:\\XAMPP\\htdocs\\flatBlog\\tpl\\index\\user-bbs-follow.html',
      1 => 1497431386,
      2 => 'file',
    ),
  ),
...
function content_594106ecb4fbe4_47130917 (Smarty_Internal_Template $_smarty_tpl) {
...
&menu=bbs&sort=follow"><?php if ($_smarty_tpl->tpl_vars['indexauth']->value != '' && $_smarty_tpl->tpl_vars['indexauth']->value['username'] == $_smarty_tpl->tpl_vars['user_info']->value['username']) {?>我<?php } else { ?>Ta<?php }?>的关注</a>
                        ...
                        <div class="main-content">
                            <div class="con-wrap">
                                <?php if (count($_smarty_tpl->tpl_vars['follow_data']->value) != 0) {?>
                                <div class="ques-list">
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['follow_data']->value, 'value', false, NULL, 'name', array (
));
if ($_from !== null) {
...
?>
                                ...
                                <?php } else { ?>
                                <p class="notattend">
                                <?php if ($_smarty_tpl->tpl_vars['indexauth']->value != '' && $_smarty_tpl->tpl_vars['indexauth']->value['username'] == $_smarty_tpl->tpl_vars['user_info']->value['username']) {?>你还没有任何关注，可以先<a href="index.php?controller=index&method=wenda" target="_blank" class="fontred">去看看技术问答</a>
                                <?php } else { ?>
                                Ta还没有任何关注
                                <?php }?>
                                </p>
