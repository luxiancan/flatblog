<?php
/* Smarty version 3.1.31, created on 2017-05-26 12:57:54
  from "F:\XAMPP\htdocs\flatBlog\tpl\index\write-article.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5927b5d28bb610_40883988',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7d964b8d004b13d93cab7d3600d7baf68e1f6746' => 
    array (
      0 => 'F:\\XAMPP\\htdocs\\flatBlog\\tpl\\index\\write-article.html',
      1 => 1495774572,
      2 => 'file',
    ),
  ),
...
function content_5927b5d28bb610_40883988 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8" />
    <title>发表文章 - 七院创新基地</title>
                    ...
                    <div class="release-form article-form">
                        <div class="form-group rel-tle art-tle">
                            ...
                            <div class="form-ipt-wrap">
                                ...
                                <input type="text" id="art-title" class="rel-title art-title" placeholder="请输入标题，最多32个单位长度">
                                <input type="radio" class="art-type" name="art-type" value="1" id="ori"><label for="ori">原创</label>
                                <input type="radio" class="art-type" name="art-type" value="2" id="rep"><label for="rep">转载</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-ipt-wrap edit-area">
                                ...
                                <textarea id="art-edit" class="art-edit" name="art-edit" placeholder="请输入文章内容"></textarea>
                                <p class="form-ipt-error"></p>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="form-ipt-wrap edit-area-de">
                                ...
                                <textarea id="abs-edit" class="de-edit" name="abs-edit" placeholder="(选填)"></textarea>
                            </div>
                        </div>
...
>
 ...
 type="text/javascript">
        ...
        function artErrorTip(){
            var len = $("#art-title").val().replace(/\s+/g,"").length;
            if(len<10){
        ...
        function yanzheng(){
            var art_tle = $("#art-title").val().replace(/\s+/g,""),
                art_type = $(".art-type:checked").val(),
                art_con = $("#art-edit").val(),
                art_con_len = art_con.replace(/\s+/g,"").length,
                art_abs = $("#abs-edit").val().replace(/\s+/g,""),
            ...
            art_abs = (art_abs=="")?art_con.substr(0,100):art_abs.substr(0,100);
...
';
                    ...
                    $.post(url, data, function(res){
                        ...
                        if(jsonObj.result=='2'){
                            window.location = "index.php?controller=index&method=articlesavesuccess&id="+jsonObj.id;
                        }
                    });
                }
            }
