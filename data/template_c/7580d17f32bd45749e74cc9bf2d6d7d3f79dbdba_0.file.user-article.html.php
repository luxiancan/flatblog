<?php
/* Smarty version 3.1.31, created on 2017-06-21 16:16:29
  from "F:\XAMPP\htdocs\flatBlog\tpl\index\user-article.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_594a2b5d3de198_03457787',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7580d17f32bd45749e74cc9bf2d6d7d3f79dbdba' => 
    array (
      0 => 'F:\\XAMPP\\htdocs\\flatBlog\\tpl\\index\\user-article.html',
      1 => 1498032973,
      2 => 'file',
    ),
  ),
...
function content_594a2b5d3de198_03457787 (Smarty_Internal_Template $_smarty_tpl) {
                                    ...
                                    <div class="right-wrap">
                                        ...
                                        <div class="type-select l">
                                            <select id="sel-type">
                                                ...
                                                <option value="1" <?php if ($_smarty_tpl->tpl_vars['val']->value == 1) {?> selected='selected' <?php }?>>原创</option>
                                                <option value="2" <?php if ($_smarty_tpl->tpl_vars['val']->value == 2) {?> selected='selected' <?php }?>>转载</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
...
"><?php echo $_smarty_tpl->tpl_vars['value']->value['title'];?>
                                            ...
                                            <td><?php if ($_smarty_tpl->tpl_vars['value']->value['cat_name'] == 1) {?>原创<?php } else { ?>转载<?php }?></td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['read_num'];?>
</td>
                                            <td><?php echo $_smarty_tpl->tpl_vars['value']->value['comment_num'];?>
</td>
                                            <?php if ($_smarty_tpl->tpl_vars['indexauth']->value != '' && $_smarty_tpl->tpl_vars['indexauth']->value['username'] == $_smarty_tpl->tpl_vars['user_info']->value['username']) {?>
                                            <td>
                                                <a href="index.php?controller=index&method=articlewrite&id=<?php echo $_smarty_tpl->tpl_vars['value']->value['id'];?>
">编辑</a> |
...
?>
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['count']->value > $_smarty_tpl->tpl_vars['homepagesize']->value) {?>
                                <div class="page-wrap">
 ...
 type="text/javascript">
        $(function(){
            ...
            $("#sel-type").on("change",function(){
                ...
                if(value==1 || value==2){
                    window.location = "index.php?controller=index&method=user&id=<?php echo $_smarty_tpl->tpl_vars['user_info']->value['id'];?>
&menu=articles&value="+value;
                }else{
                    window.location = "index.php?controller=index&method=user&id=<?php echo $_smarty_tpl->tpl_vars['user_info']->value['id'];?>
&menu=articles";
                }
